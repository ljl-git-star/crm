...
<div id="tb">
    ...
    <div>
        菜单名： <input type="text" id="s_moduleName" size="20" onkeydown="if(event.keyCode==13) searchModules()"/>
        操作码： <input type="text" id="s_code" size="20" onkeydown="if(event.keyCode==13) searchModules()"/>
        ...
        <table cellspacing="8px">
            ...
            <tr>
                ...
                <td><input id="parentId" class="easyui-combobox" name="parentId"
                           valueField="id" textField="moduleName" url="${ctx}/module/queryAllModulesByGrade?grade=0"/>
